        ...
        <main>
            <div class="flex">
                 ...
                 <div class="w-52 ml-28 border border-slate-300 flex flex-col  p-4 space-y-4">
                    <div>
                        <dl>
                            <dt class="my-2 bg-amber-800 text-yellow-100 text-center">種類</dt>
                            <dd class="space-y-2">
                    ...
                    <div>
                        <dl>
                            <dt class="mb-2 bg-amber-800 text-yellow-100 text-center">味</dt>
                            <dd class="space-y-2">
                                <label class="flex items-center">
                    ...
                    <div>
                        <dl>
                            <dt class="mb-2 bg-amber-800 text-yellow-100 text-center">都道府県</dt>
                    ...
                    <div>
                        <dl>
                            <dt class="mb-2 bg-amber-800 text-yellow-100 text-center">おいしさ</dt>
                            <dd class="space-y-2">
                                <label class="flex items-center">
                 ...
                 <!--review content-->
                <section class="mr-28 bg-gray-100">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class="p-4 bg-rose-700 w-full">
                                            <div class="flex mx-auto">
                                                ...
                                                <div>
                                                    <span class="text-white font-bold  mr-4">おいしさ :</span>
                                                    <span class="rating">
                                                        @for ($i = 1; $i <= 5; $i++)
                                                            @if ($i <= $post->rating)
